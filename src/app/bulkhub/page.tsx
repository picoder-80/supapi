...
export default function BulkHubPage() {
  ...
  useEffect(() => {
    ...
    const checkSupplier = async () => {
      const r = await fetch("/api/bulkhub/products", { headers: { Authorization: `Bearer ${token()}` } });
    };
  }, [user]);
  ...
  const handleRegisterSupplier = async () => {
    ...
    try {
      ...
      if (d.success) {
        ...
        showToast("🎉 Welcome to BulkHub! +100 SC earned!");
        fetchData();
      } else {
        ...
        {activeTab === "suppliers" && (
          loading ? (
            ...
            <div className={styles.empty}>
              ...
              <div className={styles.emptyDesc}>Be the first Pi Network supplier on BulkHub!</div>
      ...
      {showRegModal && (
        <div className={styles.modal}>
          ...
          <div className={styles.modalSheet}>
            ...
            <div className={styles.modalSub}>Join BulkHub and reach Pi Network buyers worldwide. +100 SC bonus!</div>
            ...
            <input className={styles.formInput} placeholder="e.g. Malaysia" value={regForm.country}
