...
const PLATFORMS = [
  ...
  { id: "jobs",       emoji: "🧑‍💻", label: "SupaHiro",     href: (u: string) => `/supamarket?category=jobs_services&seller=${u}`, countKey: "jobs" },
  { id: "classifieds",emoji: "📋", label: "Supasifieds",  href: (u: string) => `/supamarket?category=property&seller=${u}`,     countKey: "classifieds" },
