  ...
  if (!user)
    return (
      <div className={styles.authWall}>
        ...
        <div className={styles.authTitle}>Sign in to post an ad</div>
  ...
  return (
    <div className={styles.page}>
      <div className={styles.topBar}>
        ...
        <button className={styles.iconBtn} type="button" aria-label="Share" disabled>
          ⤴
        </button>
      </div>
              ...
              <div className={styles.formCard}>
                <div className={styles.form}>
                  ...
                  <div className={styles.formField}>
                    ...
                    <input className={styles.input} placeholder="City / state" value={form.location} onChange={(e) => set("location", e.target.value)} />
                  </div>

                  <div className={styles.formField}>
                    <label className={styles.label}>Listing country</label>
                  ...
                  <div className={styles.row}>
                    <div className={styles.formField}>
                      ...
                      <input className={styles.input} placeholder="+60..." value={form.contact_phone} onChange={(e) => set("contact_phone", e.target.value)} />
                    </div>
                    <div className={styles.formField}>
              ...
              <div className={styles.formCard}>
                <div className={styles.form}>
                  ...
                  <div className={styles.imgGrid}>
                    ...
                    {uploading && <div className={styles.uploadSkeleton} aria-hidden />}
                ...
                <div className={styles.previewSide}>
                  <div className={styles.previewCard}>
                    <div className={styles.previewBody}>
                      ...
                      <div className={styles.escrowBanner}>No escrow — contact the seller directly</div>
        ...
        <aside className={styles.rightCol}>
          <div className={styles.infoCard}>
            ...
            <ul className={styles.infoList}>
              ...
              <li>Add a phone number so buyers can reach you</li>
            </ul>
          </div>
        </aside>
      </div>
      ...
      <div className={styles.stickyBottomBar}>
        ...
        {step !== "preview" ? (
          ...
          >
            {step === "details" ? "Next: Photos" : "Preview"}
          </button>
        ) : (
